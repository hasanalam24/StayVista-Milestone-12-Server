...
async function run() {
  try {
    ...
    //get a user into by email from db
    ...
    //get a single room data from db using
    ...
    //   const result=await roomsCollection.insertOne(express.query)
    // })
